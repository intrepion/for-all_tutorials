...
Instructions for building `model-showroom` from the spec using one setup path and separate core and adapter walkthroughs.
...
For this project, the core repo should expose `build_showroom_scene`, and the adapter repo should render one local 3D model by delegating the canonical orbit and control defaults to that core contract.
