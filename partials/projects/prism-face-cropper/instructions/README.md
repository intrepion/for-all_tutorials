...
Instructions for building `prism-face-cropper` from the spec using one setup path and separate core and adapter walkthroughs.
...
For this project, the core repo should expose the crop-plan contracts, and the adapter repo should render one preview tile per face slot by delegating all face-rectangle math to the core.
