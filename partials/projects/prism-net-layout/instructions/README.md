...
Instructions for building `prism-net-layout` from the spec using one setup path and separate core and adapter walkthroughs.
...
For this project, the core repo should expose the prism-dimension and net-layout contracts, and the adapter repo should render a flat box net by delegating size and placement math to the core.
