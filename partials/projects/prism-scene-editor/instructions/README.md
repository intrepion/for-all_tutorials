...
Instructions for building `prism-scene-editor` from the spec using one setup path and separate core and adapter walkthroughs.
...
For this project, the core repo should own the editable scene document, and the adapter repo should present a live prism editor that updates the scene and preview together.
