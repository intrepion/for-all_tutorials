...
Instructions for building `prism-widget-renderer` from the spec using one setup path and separate core and adapter walkthroughs.
...
For this project, the core repo should own the camera, visibility, and render-order rules, and the adapter repo should express the prism as transformed widgets instead of dropping into a heavyweight 3D engine.
