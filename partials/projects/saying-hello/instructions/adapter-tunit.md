...
rm tests/SayingHello.CommandLine.Tests/BasicTests.cs
rm tests/SayingHello.CommandLine.Tests/Calculator.cs
rm tests/SayingHello.CommandLine.Tests/DataDrivenTests.cs
rm tests/SayingHello.CommandLine.Tests/DependencyInjectionTests.cs
rm tests/SayingHello.CommandLine.Tests/HooksAndLifecycle.cs
```
...
{
    [Test]
    public async Task Build_message_delegates_to_greeting_service_for_first_argument()
    {
...
public sealed class CommandLineGreetingTests
{
    ...
    [Test]
    public async Task Build_message_returns_generic_greeting_when_no_arguments_are_present()
    {
        var greetingService = new Mock<IGreetingService>();
