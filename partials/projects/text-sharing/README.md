...
- building a full-stack web app with form submission and content-display routes
...
- pre-filling a create form from an existing snippet for editing
- separating routing, persistence, and form handling from deterministic snippet logic
