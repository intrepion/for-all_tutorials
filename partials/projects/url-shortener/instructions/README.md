...
For this project, the core repo should expose `build_short_link_record`, `format_short_link_path`, `increment_short_link_visit_count`, and `format_short_link_stats`, and the adapter repo should implement the chosen input flow, persistence, short-path resolution, and stats behavior by delegating to those core functions.
