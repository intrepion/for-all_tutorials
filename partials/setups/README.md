---
partial_kind: setups-root
source_scope: setup-partials
---

# Setups

Setup-source slices for future compiled tutorials.

These files are authoring material for the currently piloted stack combinations. They are not generated tutorial output.
