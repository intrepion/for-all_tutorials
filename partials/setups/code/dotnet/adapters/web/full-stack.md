...
- one guide from [Storage](../../../storage/README.md) when the chosen project persists application data
...
- pairing the adapter with a stack-specific storage guide when the project persists application data

This guide does not cover:

- choosing a specific `.NET` web framework
- project-specific routes, pages, or components
- project-specific persistence mechanics beyond choosing the right storage guide
- project-specific auth or realtime behavior
...
If the chosen project persists application data, pair this guide with one storage guide from [Storage](../../storage/web/README.md).
