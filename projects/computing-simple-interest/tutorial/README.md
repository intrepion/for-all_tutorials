<!-- breadcrumbs:start -->
[for-all_tutorials](../../../README.md) / [Projects](../../README.md) / [Computing Simple Interest](../README.md) / Tutorial
<!-- breadcrumbs:end -->

# Tutorial

Instructions for building `computing-simple-interest` from the spec using one setup path and separate core and adapter walkthroughs.
...
For this project, the core repo should expose `calculate_simple_interest` and `format_simple_interest_report`, and the adapter repo should parse the prompted principal into a whole number and the prompted annual rate into the exact scaled integer expected by the core before delegating calculation and report formatting to those core functions.
