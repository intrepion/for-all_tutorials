<!-- breadcrumbs:start -->
[for-all_tutorials](../../../README.md) / [Projects](../../README.md) / [Printing Quotes](../README.md) / Tutorial
<!-- breadcrumbs:end -->

# Tutorial

Instructions for building `printing-quotes` from the spec using one setup path and separate core and adapter walkthroughs.
...
For this project, the core repo should expose `format_attributed_quote`, and the adapter repo should collect the author and quote before delegating formatting to that core function.
