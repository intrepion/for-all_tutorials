<!-- breadcrumbs:start -->
[for-all_tutorials](../../../README.md) / [Projects](../../README.md) / [Self-Checkout](../README.md) / Tutorial
<!-- breadcrumbs:end -->

# Tutorial

Instructions for building `self-checkout` from the spec using one setup path and separate core and adapter walkthroughs.
...
For this project, the core repo should expose `calculate_checkout_summary` and `format_checkout_report`, and the adapter repo should parse the prompted prices into exact cent values and the prompted quantities into whole numbers before delegating checkout calculation and report formatting to those core functions.
