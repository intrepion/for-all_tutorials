<!-- breadcrumbs:start -->
[for-all_tutorials](../../../README.md) / [Projects](../../README.md) / [Simple Math](../README.md) / Tutorial
<!-- breadcrumbs:end -->

# Tutorial

Instructions for building `simple-math` from the spec using one setup path and separate core and adapter walkthroughs.
...
For this project, the core repo should expose `calculate_simple_math` and `format_simple_math_report`, and the adapter repo should parse two prompted inputs into numbers before delegating arithmetic and report formatting to those core functions.
