<!-- breadcrumbs:start -->
[for-all_tutorials](../../../README.md) / [Projects](../../README.md) / [Validating Inputs](../README.md) / Tutorial
<!-- breadcrumbs:end -->

# Tutorial

Instructions for building `validating-inputs` from the spec using one setup path and separate core and adapter walkthroughs.
...
For this project, the core repo should expose the field validators, `collect_validation_errors`, and `format_validation_report`, and the adapter repo should collect the four inputs before delegating validation and final message creation to those core functions.
