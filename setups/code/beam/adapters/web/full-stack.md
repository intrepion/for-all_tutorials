<!-- breadcrumbs:start -->
[for-all_tutorials](../../../../../../README.md) / [Setups](../../../../../README.md) / [Code](../../../../README.md) / [beam](../../../README.md) / [Adapters](../../README.md) / [Web](../README.md) / full-stack.md
<!-- breadcrumbs:end -->

# Full Stack

Reusable BEAM adapter setup for the `web/full-stack` target.
...
The BEAM `web/full-stack` adapter should stay thin:
...
The BEAM `web/full-stack` adapter setup is ready when:
