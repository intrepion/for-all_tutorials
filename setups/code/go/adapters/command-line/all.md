<!-- breadcrumbs:start -->
[for-all_tutorials](../../../../../../README.md) / [Setups](../../../../../README.md) / [Code](../../../../README.md) / [go](../../../README.md) / [Adapters](../../README.md) / [Command Line](../README.md) / all.md
<!-- breadcrumbs:end -->

# All

Reusable Go adapter setup for the `command-line/all` target.
...
The Go `command-line/all` adapter should stay thin:
...
The Go `command-line/all` adapter setup is ready when:
