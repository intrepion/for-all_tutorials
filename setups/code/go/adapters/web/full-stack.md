<!-- breadcrumbs:start -->
[for-all_tutorials](../../../../../../README.md) / [Setups](../../../../../README.md) / [Code](../../../../README.md) / [go](../../../README.md) / [Adapters](../../README.md) / [Web](../README.md) / full-stack.md
<!-- breadcrumbs:end -->

# Full Stack

Reusable Go adapter setup for the `web/full-stack` target.
...
The Go `web/full-stack` adapter should stay thin:
...
The Go `web/full-stack` adapter setup is ready when:
