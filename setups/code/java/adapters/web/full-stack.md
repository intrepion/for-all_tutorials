<!-- breadcrumbs:start -->
[for-all_tutorials](../../../../../../README.md) / [Setups](../../../../../README.md) / [Code](../../../../README.md) / [java](../../../README.md) / [Adapters](../../README.md) / [Web](../README.md) / full-stack.md
<!-- breadcrumbs:end -->

# Full Stack

Reusable Java adapter setup for the `web/full-stack` target.
...
The Java `web/full-stack` adapter should stay thin:
...
The Java `web/full-stack` adapter setup is ready when:
