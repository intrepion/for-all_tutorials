<!-- breadcrumbs:start -->
[for-all_tutorials](../../../../../../README.md) / [Setups](../../../../../README.md) / [Code](../../../../README.md) / [javascript](../../../README.md) / [Adapters](../../README.md) / [Web](../README.md) / full-stack.md
<!-- breadcrumbs:end -->

# Full Stack

Reusable JavaScript adapter setup for the `web/full-stack` target.
...
The JavaScript `web/full-stack` adapter should stay thin:
...
The JavaScript `web/full-stack` adapter setup is ready when:
