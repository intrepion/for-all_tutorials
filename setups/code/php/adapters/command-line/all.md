<!-- breadcrumbs:start -->
[for-all_tutorials](../../../../../../README.md) / [Setups](../../../../../README.md) / [Code](../../../../README.md) / [php](../../../README.md) / [Adapters](../../README.md) / [Command Line](../README.md) / all.md
<!-- breadcrumbs:end -->

# All

Reusable PHP adapter setup for the `command-line/all` target.
...
The PHP `command-line/all` adapter should stay thin:
...
The PHP `command-line/all` adapter setup is ready when:
