<!-- breadcrumbs:start -->
[for-all_tutorials](../../../../../../README.md) / [Setups](../../../../../README.md) / [Code](../../../../README.md) / [ruby](../../../README.md) / [Adapters](../../README.md) / [Web](../README.md) / full-stack.md
<!-- breadcrumbs:end -->

# Full Stack

Reusable Ruby adapter setup for the `web/full-stack` target.
...
The Ruby `web/full-stack` adapter should stay thin:
...
The Ruby `web/full-stack` adapter setup is ready when:
