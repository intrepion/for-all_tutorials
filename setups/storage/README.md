<!-- breadcrumbs:start -->
[for-all_tutorials](../../README.md) / [Setups](../README.md) / Storage
<!-- breadcrumbs:end -->

# Storage

Storage and database setup guides for project tutorials.

The storage slot in every adapter repo name should use one of these canonical values:
