<!-- breadcrumbs:start -->
[for-all_tutorials](../../../README.md) / [Specs](../../README.md) / [Level 001: Foundations](../README.md) / Todo List
<!-- breadcrumbs:end -->

# Todo List

Canonical spec for this Level 001: Foundations tutorial app.
...
This spec should stay intentionally small. It is the reference pattern for future foundational specs, not a feature-rich task manager.
